...
class EspacioTipoUsuarioConfigException extends Exception
{
    protected $statusCode;
    protected $errorType;

    /**
     * Constructor para la excepción personalizada de usuarios
     *
    ...
    public function __construct(
        string $message = 'Error en la operación de tipo configuracion usuario',
